...
def is_github_repo(url: str) -> bool:
    try:
        ...
        non_repo_paths = {
            ...
            'explore', 'topics', 'collections', 'events', 'features',
            'security', 'enterprise', 'pricing', 'search'
        }
...
def classify_url(url: str):
    ...
    tutorial_patterns = [
        r'/tutorial', r'/learn', r'/course', r'/lesson', r'/documentation',
        r'/workshop', r'/training', r'/education',
        r'/lecture', r'/class', r'/syllabus', r'/curriculum',
        r'/mooc', r'/resources', r'/study', r'/teach',
        r'/explained', r'/introduction', r'/basics', r'/beginner',
        r'/degree', r'/assignment', r'/quiz', r'/test',
        r'/exam', r'/practice', r'/exercise', r'/problem',
        r'/solution', r'/example', r'/demo', r'/showcase',
        r'/walkthrough', r'/step-by-step', r'/crash-course'
    ]

    educational_keywords = [
        'tutorial', 'learn', 'course', 'lesson', 'lecture',
        'educational', 'teaching', 'explained', 'introduction',
        'guide', 'how to', 'basics', 'fundamentals', 'principles',
        'crash course', 'for beginners', '101', 'masterclass',
        'workshop', 'training', 'education', 'walkthrough',
        'step by step', 'introduction to', 'getting started',
        'complete guide', 'comprehensive', 'deep dive',
        'explanation', 'understand', 'concept', 'theory',
        'practice', 'example', 'demonstration', 'experiment',
        'review', 'study with me', 'lecture notes'
    ]
        ...
        if 'youtube.com' in domain or 'youtu.be' in domain:
            ...
            if '/c/' in url_lower or '/channel/' in url_lower:
                educational_channels = [
                    'crash course', 'khan academy', 'mit', 'stanford',
                    'harvard', 'ted-ed', 'vsauce', '3blue1brown',
            ...
            return any(keyword in video_title.lower() for keyword in educational_keywords)
            
        return False

    if domain in educational_platforms.keys():
        platform_type = next((v for k, v in educational_platforms.items() if k in domain), None)
...
def get_webpage_title(url: str) -> Dict[str, Optional[str]]:
    ...
    title = reduce(
        lambda x, f: f(x) if x is not None else None,
        pipeline,
        url
    )
